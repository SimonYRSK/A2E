...
def main():
    ...
    if "RANK" not in os.environ:
        raise RuntimeError("main_align.py 需要通过 torchrun 启动，例如: torchrun --nproc_per_node=4 A2E/mainA2E_align0520.py")
    ...
    trainer = FSDPUNetAlignTrainer(
        ...
        device=device,
        beta=1e-4,
        tb_dir="/home/ximutian/tensorboard_logs/A2E_0520_test",
        save_dir="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/A2E/checkpoints/A2E_0520_test",
        save_interval=1,
        use_amp=False,
        rank=rank,
        ...
        kl_anneal=False,
        kl_anneal_epochs=7,
        plot_root="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/A2E/channelpics/A2E_0520_test",
        recon_loss_type="l1",
