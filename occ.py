...
def main():
    ...
    trainer = FSDPUNetAlignTrainer(
        ...
        save_dir="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/A2E/checkpoints/occ",
        save_interval=100,
        use_amp=False,
        rank=rank,
        ...
        kl_anneal=False,
        kl_anneal_epochs=7,
        plot_root="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/MutianXi/A2E/channelpics/occ",
        recon_loss_type="l1",
